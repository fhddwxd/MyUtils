...
//                this.canvas.drawCircle(xPos,  yPos + (i * (circleRadius * 3)),  circleRadius, this.inFill);
                this.canvas.drawRect(xPos,yPos+(i*(legth+40)),xPos+legth,yPos+legth+(i*(legth+40)),this.inFill);
            } else {
//                this.canvas.drawCircle(xPos,  yPos + (i * (circleRadius * 3)),  circleRadius, this.circleBackGround);
                this.canvas.drawRect(xPos,yPos+(i*(legth+40)),xPos+legth,yPos+legth+(i*(legth+40)),this.circleBackGround);
            }
        }
