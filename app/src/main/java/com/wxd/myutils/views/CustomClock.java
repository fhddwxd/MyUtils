...
public class CustomClock extends View {
    ...
    private void initPaint() {
        ...
        mCircleBackgroundPaint.setStrokeWidth(10);//设置线宽
        mCircleBackgroundPaint.setColor(Color.WHITE);//设置颜色
        mCircleBackgroundPaint.setAlpha(100);
        ...
        mDrawHandPaint.setColor(Color.BLACK);
    ...
    private void drawTickMarkerOrTime(Canvas canvas) {
        ...
        for (int i = 0; i < 60; i++) {
            if (i % 5 == 0) {
                ...
                canvas.save();
                Rect rect1 = new Rect();
                mTickMarkerShortPaint.setTextSize(50);
